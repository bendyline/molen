...
export interface ExplorerPerformanceTier {
  name: string;
...
export function explorerPerformanceTier(level: number): ExplorerPerformanceTier {
...
export function explorerPixelRatio(
  level: number,
  width: number,
  height: number,
  deviceRatio: number,
...
export function manualQualityLevel(quality: TerrainQualityPreset): number {
