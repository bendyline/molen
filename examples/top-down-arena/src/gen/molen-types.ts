// AUTO-GENERATED by `molen types gen` — do not edit. inputs-hash: sha256:7d2ad393ff0c708044519bcddcba061cb5613fcafcb8aae340523bf136b162b2
...
export const TYPE_DEFS: Readonly<Record<string, { doc?: string; extends?: string }>> = {
  'arena.enemy': { doc: 'A chaser: 1 hp kinematic circle that damages the player on contact.' },
  'arena.player': { doc: 'The player-controlled body: kinematic circle, 10 hp, driven by the move command.' },
  'arena.wall': { doc: 'Static arena boundary segment. Override collider.halfExtents + renderable.primitive.size per wall.' },
};
