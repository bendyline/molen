...
// Ambient types for the scripts in this directory, from "types/aircraft.types.json".
...
interface MolenScriptConfig {
  /** script 'molen.entities.aircraft.h500md:interactions' */
