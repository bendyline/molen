...
export {
  ...
  type TerrainArchiveHeader,
  type TerrainArchiveTile,
  ...
  type TerrainPackageSemanticContent,
  ...
  type TerrainSemanticTileDecodeContext,
  type TerrainSemanticTileDecoder,
